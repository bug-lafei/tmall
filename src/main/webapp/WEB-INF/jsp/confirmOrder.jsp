...
<div class="buyPageDiv">
    ...
    <!--提交表单要进行的表单信息填写-->
    <form id="orderCommitForm" action="<%=request.getContextPath()%>/payPage" method="post">
        <!--收货地址div-->
        <p>收货地址：</p>
        <c:forEach items="${addresses}" var="address">
            <div class="radio-sex" style="font-size: 15px">
                <input type="radio" id="sex1" name="aid" value="${address.id}">
        ...
        <br>
        <p style="font-size: 20px;cursor: pointer" class="coupon-p" onclick="a()">优惠卷﹀</p>
            ...
            <c:forEach items="${coupons}" var="coupon">
                <div class="coupon" style=" margin-left: 50px">
                    <div class="stamp stamp04">
                        ...
                        <p id="selectC"style="font-size: 20px">使用<input id="radioC" type="radio"></p>
                    </div>
                </div>
            </c:forEach>
        </div>
...
<%--                            <a class="orderItemProductLink" href="getProductDetail.do?pid=${orderItem['product']['id']}&cid=${orderItem['product']['category']['id']}">${orderItem['product']['name']}</a>--%>
                            <img src="images/site/7day.png" alt="图片加载失败" title="7天保障">
                        ...
                        <td><span class="orderItemProductNumber">${product.store}</span></td>
                        <input type="hidden" value="${product.store}" name="number">
                        <input type="hidden" value="${product.id}" name="pid">
                        <td><span id="orderItemProductSumPrice" class="orderItemProductSumPrice">
<%--                            <fmt:formatNumber value="${product.nprice}" minFractionDigits="2"/>--%>
                    ${product.store * product.nprice}
                        </span></td>
        ...
        <div class="submitOrderDiv">
            ...
            <a id="a1" class="submitOrderLink"><button class="submitOrderButton" type="submit">提交订单</button></a>
        </div>
    </form>
...
<script>
    $(function () {
        ...
        $("img.leaveMessageImg").click(function () {
            ...
            $("span.orderItemTotalSumSpan").text(sum-cash);
