...
<jsp:include page="header_nav.jsp"/>
    ...
    <div class="registerDiv">
        <form action="<%=request.getContextPath()%>/foundPassword" method="post">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="registerTableRightTD">
                        <input type="hidden"  name="username" id="username" value="${passwordUser.username}" >
                        <input type="text"  name="" id="" value="${passwordUser.username}" disabled>
