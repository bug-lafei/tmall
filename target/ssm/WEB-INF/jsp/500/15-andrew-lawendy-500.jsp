...
<html>
	<head>
		<meta charset="utf-8">
		<title>404 Andrew Lawendy</title>
		<link rel="stylesheet" href="https://rsupanta-weather.herokuapp.com/css/404.css">
		</head>
		...
		<body>
		    <div class="not-found parallax">
		        ...
		        <a class="wave-island" href="<%=request.getContextPath()%>/index">
